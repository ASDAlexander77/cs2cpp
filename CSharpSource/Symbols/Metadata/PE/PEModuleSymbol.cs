...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal sealed class PEModuleSymbol : NonMissingModuleSymbol
    {
        ...
        private IEnumerable<KeyValuePair<string, string>> lazyTypeWithNamespaceNames;
        ...
        internal override IEnumerable<KeyValuePair<string, string>> TypeWithNamespaceNames
        {
            get
            {
                if (this.lazyTypeWithNamespaceNames == null)
                {
                    Interlocked.CompareExchange(ref this.lazyTypeWithNamespaceNames, module.TypeWithNamespaceNames, null);
                }

                return this.lazyTypeWithNamespaceNames;
            }
        }
