...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum BoundKind: byte
    {
        ...
        UninitializedVarDeclarationExpression,
        RangeVariable,
        Parameter,
        LabelStatement,
        GotoStatement,
    ...
    {
        public BoundFieldInitializer(CSharpSyntaxNode syntax, FieldSymbol field, BoundExpression initialValue, bool hasErrors = false)
    ...
    {
        public BoundGlobalStatementInitializer(CSharpSyntaxNode syntax, BoundStatement statement, bool hasErrors = false)
    ...
    internal sealed partial class BoundInitializationScope : BoundInitializer
    {
        public BoundInitializationScope(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> locals, ImmutableArray<BoundInitializer> initializers, bool hasErrors = false)
            : base(BoundKind.InitializationScope, syntax, hasErrors || initializers.HasErrors())
        {
        ...
        public ImmutableArray<BoundInitializer> Initializers { get; private set; }

        public override BoundNode Accept(BoundTreeVisitor visitor)
        {
            return visitor.VisitInitializationScope(this);
        }

        public BoundInitializationScope Update(ImmutableArray<LocalSymbol> locals, ImmutableArray<BoundInitializer> initializers)
        {
            if (locals != this.Locals || initializers != this.Initializers)
            {
                var result = new BoundInitializationScope(this.Syntax, locals, initializers, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundBadExpression(CSharpSyntaxNode syntax, LookupResultKind resultKind, ImmutableArray<Symbol> symbols, ImmutableArray<BoundNode> childBoundNodes, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<Symbol> Symbols { get; private set; }

        public ImmutableArray<BoundNode> ChildBoundNodes { get; private set; }
    ...
    {
        public BoundBadStatement(CSharpSyntaxNode syntax, ImmutableArray<BoundNode> childBoundNodes, bool hasErrors = false)
    ...
    {
        public BoundTypeExpression(CSharpSyntaxNode syntax, AliasSymbol aliasOpt, bool inferredType, BoundTypeExpression boundContainingTypeOpt, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundTypeOrValueExpression(CSharpSyntaxNode syntax, Symbol variable, Binder binder, TypeSymbol type, bool hasErrors)
        ...
        public BoundTypeOrValueExpression(CSharpSyntaxNode syntax, Symbol variable, Binder binder, TypeSymbol type)
    ...
    {
        public BoundUnaryOperator(CSharpSyntaxNode syntax, UnaryOperatorKind operatorKind, BoundExpression operand, ConstantValue constantValueOpt, MethodSymbol methodOpt, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundAddressOfOperator(CSharpSyntaxNode syntax, BoundExpression operand, bool isFixedStatementAddressOf, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundPointerIndirectionOperator(CSharpSyntaxNode syntax, BoundExpression operand, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundPointerElementAccess(CSharpSyntaxNode syntax, BoundExpression expression, BoundExpression index, Boolean @checked, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundRefTypeOperator(CSharpSyntaxNode syntax, BoundExpression operand, MethodSymbol getTypeFromHandle, TypeSymbol type, bool hasErrors = false)
        ...
        public MethodSymbol GetTypeFromHandle { get; private set; }
    ...
    {
        public BoundMakeRefOperator(CSharpSyntaxNode syntax, BoundExpression operand, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundRefValueOperator(CSharpSyntaxNode syntax, BoundExpression operand, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundBinaryOperator(CSharpSyntaxNode syntax, BinaryOperatorKind operatorKind, BoundExpression left, BoundExpression right, ConstantValue constantValueOpt, MethodSymbol methodOpt, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundCompoundAssignmentOperator(CSharpSyntaxNode syntax, BinaryOperatorSignature @operator, BoundExpression left, BoundExpression right, Conversion leftConversion, Conversion finalConversion, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundAssignmentOperator(CSharpSyntaxNode syntax, BoundExpression left, BoundExpression right, RefKind refKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundNullCoalescingOperator(CSharpSyntaxNode syntax, BoundExpression leftOperand, BoundExpression rightOperand, Conversion leftConversion, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundConditionalOperator(CSharpSyntaxNode syntax, BoundExpression condition, BoundExpression consequence, BoundExpression alternative, ConstantValue constantValueOpt, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundArrayAccess(CSharpSyntaxNode syntax, BoundExpression expression, ImmutableArray<BoundExpression> indices, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<BoundExpression> Indices { get; private set; }
    ...
    {
        public BoundArrayLength(CSharpSyntaxNode syntax, BoundExpression expression, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundAwaitExpression(CSharpSyntaxNode syntax, BoundExpression expression, MethodSymbol getAwaiter, PropertySymbol isCompleted, MethodSymbol getResult, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundTypeOfOperator(CSharpSyntaxNode syntax, BoundTypeExpression sourceType, MethodSymbol getTypeFromHandle, TypeSymbol type, bool hasErrors = false)
    ...
    internal sealed partial class BoundMethodInfo : BoundExpression
    {
        ...
        public MethodSymbol GetMethodFromHandle { get; private set; }
    ...
    internal sealed partial class BoundFieldInfo : BoundExpression
    {
        ...
        public MethodSymbol GetFieldFromHandle { get; private set; }
    ...
    {
        public BoundIsOperator(CSharpSyntaxNode syntax, BoundExpression operand, BoundTypeExpression targetType, Conversion conversion, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundAsOperator(CSharpSyntaxNode syntax, BoundExpression operand, BoundTypeExpression targetType, Conversion conversion, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundSizeOfOperator(CSharpSyntaxNode syntax, BoundTypeExpression sourceType, ConstantValue constantValueOpt, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundConversion(CSharpSyntaxNode syntax, BoundExpression operand, ConversionKind conversionKind, LookupResultKind resultKind, Boolean isBaseConversion, MethodSymbol symbolOpt, Boolean @checked, Boolean explicitCastInCode, Boolean isExtensionMethod, Boolean isArrayIndex, ConstantValue constantValueOpt, TypeSymbol type, bool hasErrors = false)
        ...
        public Boolean IsBaseConversion { get; private set; }
        ...
        public BoundConversion Update(BoundExpression operand, ConversionKind conversionKind, LookupResultKind resultKind, Boolean isBaseConversion, MethodSymbol symbolOpt, Boolean @checked, Boolean explicitCastInCode, Boolean isExtensionMethod, Boolean isArrayIndex, ConstantValue constantValueOpt, TypeSymbol type)
        {
            if (operand != this.Operand || conversionKind != this.ConversionKind || resultKind != this.ResultKind || isBaseConversion != this.IsBaseConversion || symbolOpt != this.SymbolOpt || @checked != this.Checked || explicitCastInCode != this.ExplicitCastInCode || isExtensionMethod != this.IsExtensionMethod || isArrayIndex != this.IsArrayIndex || constantValueOpt != this.ConstantValueOpt || type != this.Type)
            {
                var result = new BoundConversion(this.Syntax, operand, conversionKind, resultKind, isBaseConversion, symbolOpt, @checked, explicitCastInCode, isExtensionMethod, isArrayIndex, constantValueOpt, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundArgListOperator(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> arguments, ImmutableArray<RefKind> argumentRefKindsOpt, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<RefKind> ArgumentRefKindsOpt { get; private set; }
    ...
    {
        public BoundFixedLocalCollectionInitializer(CSharpSyntaxNode syntax, TypeSymbol elementPointerType, Conversion elementPointerTypeConversion, BoundExpression expression, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundSequencePoint(CSharpSyntaxNode syntax, BoundStatement statementOpt, bool hasErrors = false)
    ...
    {
        public BoundSequencePointExpression(CSharpSyntaxNode syntax, BoundExpression expression, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundSequencePointWithSpan(CSharpSyntaxNode syntax, BoundStatement statementOpt, TextSpan span, bool hasErrors = false)
    ...
    {
        public BoundIteratorScope(CSharpSyntaxNode syntax, ImmutableArray<SynthesizedFieldSymbolBase> fields, BoundStatement statement, bool hasErrors = false)
        ...
        public ImmutableArray<SynthesizedFieldSymbolBase> Fields { get; private set; }
        ...
        public BoundIteratorScope Update(ImmutableArray<SynthesizedFieldSymbolBase> fields, BoundStatement statement)
        {
    ...
    {
        public BoundLocalDeclaration(CSharpSyntaxNode syntax, LocalSymbol localSymbol, BoundTypeExpression declaredType, BoundExpression initializerOpt, ImmutableArray<BoundExpression> argumentsOpt, bool hasErrors = false)
        ...
        public ImmutableArray<BoundExpression> ArgumentsOpt { get; private set; }
    ...
    {
        public BoundMultipleLocalDeclarations(CSharpSyntaxNode syntax, ImmutableArray<BoundLocalDeclaration> localDeclarations, bool hasErrors = false)
        ...
        public ImmutableArray<BoundLocalDeclaration> LocalDeclarations { get; private set; }
    ...
    {
        public BoundSequence(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> locals, ImmutableArray<BoundExpression> sideEffects, BoundExpression value, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<BoundExpression> SideEffects { get; private set; }
    ...
    internal sealed partial class BoundNoOpStatement : BoundStatement
    {
        ...
        public NoOpStatementFlavor Flavor { get; private set; }
    ...
    {
        public BoundReturnStatement(CSharpSyntaxNode syntax, BoundExpression expressionOpt, bool hasErrors = false)
    ...
    {
        public BoundYieldReturnStatement(CSharpSyntaxNode syntax, BoundExpression expression, bool hasErrors = false)
    ...
    {
        public BoundThrowStatement(CSharpSyntaxNode syntax, BoundExpression expressionOpt, bool hasErrors = false)
    ...
    {
        public BoundExpressionStatement(CSharpSyntaxNode syntax, BoundExpression expression, bool hasErrors = false)
    ...
    internal sealed partial class BoundSwitchStatement : BoundStatement
    {
        ...
        public ImmutableArray<LocalSymbol> OuterLocals { get; private set; }
        ...
        public MethodSymbol StringEquality { get; private set; }
    ...
    {
        public BoundSwitchSection(CSharpSyntaxNode syntax, ImmutableArray<BoundSwitchLabel> boundSwitchLabels, ImmutableArray<BoundStatement> statements, bool hasErrors = false)
            : base(BoundKind.SwitchSection, syntax, statements, hasErrors || boundSwitchLabels.HasErrors() || statements.HasErrors())
        {

            Debug.Assert(!boundSwitchLabels.IsDefault, "Field 'boundSwitchLabels' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
            Debug.Assert(!statements.IsDefault, "Field 'statements' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)");
        ...
        public ImmutableArray<BoundSwitchLabel> BoundSwitchLabels { get; private set; }
        ...
        public BoundSwitchSection Update(ImmutableArray<BoundSwitchLabel> boundSwitchLabels, ImmutableArray<BoundStatement> statements)
        {
    ...
    {
        public BoundSwitchLabel(CSharpSyntaxNode syntax, LabelSymbol label, BoundExpression expressionOpt, bool hasErrors = false)
    ...
    {
        public BoundIfStatement(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> locals, BoundExpression condition, BoundStatement consequence, BoundStatement alternativeOpt, bool hasErrors = false)
    ...
    {
        public BoundDoStatement(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> innerLocals, BoundExpression condition, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel, bool hasErrors = false)
        ...
        public BoundDoStatement Update(ImmutableArray<LocalSymbol> innerLocals, BoundExpression condition, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel)
        {
            if (innerLocals != this.InnerLocals || condition != this.Condition || body != this.Body || breakLabel != this.BreakLabel || continueLabel != this.ContinueLabel)
            {
                var result = new BoundDoStatement(this.Syntax, innerLocals, condition, body, breakLabel, continueLabel, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundWhileStatement(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> innerLocals, BoundExpression condition, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel, bool hasErrors = false)
        ...
        public BoundWhileStatement Update(ImmutableArray<LocalSymbol> innerLocals, BoundExpression condition, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel)
        {
            if (innerLocals != this.InnerLocals || condition != this.Condition || body != this.Body || breakLabel != this.BreakLabel || continueLabel != this.ContinueLabel)
            {
                var result = new BoundWhileStatement(this.Syntax, innerLocals, condition, body, breakLabel, continueLabel, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundForStatement(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> outerLocals, BoundStatement initializer, ImmutableArray<LocalSymbol> innerLocals, BoundExpression condition, BoundStatement increment, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel, bool hasErrors = false)
    ...
    internal sealed partial class BoundForEachStatement : BoundLoopStatement
    {
        ...
        public BoundForEachStatement Update(ImmutableArray<LocalSymbol> outerLocals, ForEachEnumeratorInfo enumeratorInfoOpt, Conversion elementConversion, BoundTypeExpression iterationVariableType, LocalSymbol iterationVariable, BoundExpression expression, BoundStatement body, Boolean @checked, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel)
        {
            if (outerLocals != this.OuterLocals || enumeratorInfoOpt != this.EnumeratorInfoOpt || elementConversion != this.ElementConversion || iterationVariableType != this.IterationVariableType || iterationVariable != this.IterationVariable || expression != this.Expression || body != this.Body || @checked != this.Checked || breakLabel != this.BreakLabel || continueLabel != this.ContinueLabel)
            {
                var result = new BoundForEachStatement(this.Syntax, outerLocals, enumeratorInfoOpt, elementConversion, iterationVariableType, iterationVariable, expression, body, @checked, breakLabel, continueLabel, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundUsingStatement(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> locals, BoundMultipleLocalDeclarations declarationsOpt, BoundExpression expressionOpt, Conversion iDisposableConversion, BoundStatement body, bool hasErrors = false)
    ...
    {
        public BoundFixedStatement(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> locals, BoundMultipleLocalDeclarations declarations, BoundStatement body, bool hasErrors = false)
    ...
    {
        public BoundTryStatement(CSharpSyntaxNode syntax, BoundBlock tryBlock, ImmutableArray<BoundCatchBlock> catchBlocks, BoundBlock finallyBlockOpt, Boolean preferFaultHandler, bool hasErrors = false)
        ...
        public ImmutableArray<BoundCatchBlock> CatchBlocks { get; private set; }

        public BoundBlock FinallyBlockOpt { get; private set; }

        public Boolean PreferFaultHandler { get; private set; }
    ...
    {
        public BoundCatchBlock(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> locals, BoundExpression exceptionSourceOpt, TypeSymbol exceptionTypeOpt, BoundExpression exceptionFilterOpt, BoundBlock body, bool hasErrors = false)
        ...
        public BoundExpression ExceptionSourceOpt { get; private set; }

        public TypeSymbol ExceptionTypeOpt { get; private set; }

        public BoundExpression ExceptionFilterOpt { get; private set; }
        ...
        public BoundCatchBlock Update(ImmutableArray<LocalSymbol> locals, BoundExpression exceptionSourceOpt, TypeSymbol exceptionTypeOpt, BoundExpression exceptionFilterOpt, BoundBlock body)
        {
            if (locals != this.Locals || exceptionSourceOpt != this.ExceptionSourceOpt || exceptionTypeOpt != this.ExceptionTypeOpt || exceptionFilterOpt != this.ExceptionFilterOpt || body != this.Body)
            {
                var result = new BoundCatchBlock(this.Syntax, locals, exceptionSourceOpt, exceptionTypeOpt, exceptionFilterOpt, body, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundPreviousSubmissionReference(CSharpSyntaxNode syntax, NamedTypeSymbol sourceType, TypeSymbol type, bool hasErrors)
        ...
        public BoundPreviousSubmissionReference(CSharpSyntaxNode syntax, NamedTypeSymbol sourceType, TypeSymbol type)
    ...
    internal sealed partial class BoundDeclarationExpression : BoundExpression
    {
        public BoundDeclarationExpression(CSharpSyntaxNode syntax, LocalSymbol localSymbol, BoundTypeExpression declaredType, BoundExpression initializerOpt, ImmutableArray<BoundExpression> argumentsOpt, TypeSymbol type, bool hasErrors = false)
            : base(BoundKind.DeclarationExpression, syntax, type, hasErrors || declaredType.HasErrors() || initializerOpt.HasErrors() || argumentsOpt.HasErrors())
        {
        ...
        public BoundDeclarationExpression Update(LocalSymbol localSymbol, BoundTypeExpression declaredType, BoundExpression initializerOpt, ImmutableArray<BoundExpression> argumentsOpt, TypeSymbol type)
        {
            if (localSymbol != this.LocalSymbol || declaredType != this.DeclaredType || initializerOpt != this.InitializerOpt || argumentsOpt != this.ArgumentsOpt || type != this.Type)
            {
                var result = new BoundDeclarationExpression(this.Syntax, localSymbol, declaredType, initializerOpt, argumentsOpt, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    internal sealed partial class UninitializedVarDeclarationExpression : BoundExpression
    {
        public UninitializedVarDeclarationExpression(CSharpSyntaxNode syntax, LocalSymbol localSymbol, ImmutableArray<BoundExpression> argumentsOpt, bool hasErrors = false)
            : base(BoundKind.UninitializedVarDeclarationExpression, syntax, null, hasErrors || argumentsOpt.HasErrors())
        {
        ...
        public override BoundNode Accept(BoundTreeVisitor visitor)
        {
            return visitor.VisitUninitializedVarDeclarationExpression(this);
        }

        public UninitializedVarDeclarationExpression Update(LocalSymbol localSymbol, ImmutableArray<BoundExpression> argumentsOpt)
        {
            if (localSymbol != this.LocalSymbol || argumentsOpt != this.ArgumentsOpt)
            {
                var result = new UninitializedVarDeclarationExpression(this.Syntax, localSymbol, argumentsOpt, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundRangeVariable(CSharpSyntaxNode syntax, RangeVariableSymbol rangeVariableSymbol, BoundExpression value, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundGotoStatement(CSharpSyntaxNode syntax, LabelSymbol label, BoundExpression caseExpressionOpt, BoundLabel labelExpressionOpt, bool hasErrors = false)
    ...
    {
        public BoundLabeledStatement(CSharpSyntaxNode syntax, LabelSymbol label, BoundStatement body, bool hasErrors = false)
    ...
    {
        protected BoundStatementList(BoundKind kind, CSharpSyntaxNode syntax, ImmutableArray<BoundStatement> statements, bool hasErrors = false)
            : base(kind, syntax, hasErrors)
        {
        ...
        public BoundStatementList(CSharpSyntaxNode syntax, ImmutableArray<BoundStatement> statements, bool hasErrors = false)
    ...
    {
        public BoundConditionalGoto(CSharpSyntaxNode syntax, BoundExpression condition, bool jumpIfTrue, LabelSymbol label, bool hasErrors = false)
    ...
    {
        protected BoundMethodOrPropertyGroup(BoundKind kind, CSharpSyntaxNode syntax, BoundExpression receiverOpt, LookupResultKind resultKind, bool hasErrors = false)
    ...
    {
        public BoundDynamicMemberAccess(CSharpSyntaxNode syntax, BoundExpression receiver, ImmutableArray<TypeSymbol> typeArgumentsOpt, string name, bool invoked, bool indexed, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<TypeSymbol> TypeArgumentsOpt { get; private set; }
    ...
    {
        public BoundDynamicInvocation(CSharpSyntaxNode syntax, BoundExpression expression, ImmutableArray<BoundExpression> arguments, ImmutableArray<string> argumentNamesOpt, ImmutableArray<RefKind> argumentRefKindsOpt, ImmutableArray<MethodSymbol> applicableMethods, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<string> ArgumentNamesOpt { get; private set; }

        public ImmutableArray<RefKind> ArgumentRefKindsOpt { get; private set; }

        public ImmutableArray<MethodSymbol> ApplicableMethods { get; private set; }
    ...
    {
        public BoundConditionalAccess(CSharpSyntaxNode syntax, BoundExpression receiver, BoundExpression accessExpression, TypeSymbol type, bool hasErrors = false)
        ...
        public BoundExpression AccessExpression { get; private set; }
    ...
    {
        public BoundConditionalReceiver(CSharpSyntaxNode syntax, TypeSymbol type, bool hasErrors)
        ...
        public BoundConditionalReceiver(CSharpSyntaxNode syntax, TypeSymbol type)
        ...
        public BoundConditionalReceiver Update(TypeSymbol type)
        {
            if (type != this.Type)
            {
                var result = new BoundConditionalReceiver(this.Syntax, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundMethodGroup(CSharpSyntaxNode syntax, ImmutableArray<TypeSymbol> typeArgumentsOpt, string name, ImmutableArray<MethodSymbol> methods, Symbol lookupSymbolOpt, DiagnosticInfo lookupError, BoundMethodGroupFlags flags, BoundExpression receiverOpt, LookupResultKind resultKind, bool hasErrors = false)
        ...
        public ImmutableArray<MethodSymbol> Methods { get; private set; }
    ...
    {
        public BoundPropertyGroup(CSharpSyntaxNode syntax, ImmutableArray<PropertySymbol> properties, BoundExpression receiverOpt, LookupResultKind resultKind, bool hasErrors = false)
        ...
        public ImmutableArray<PropertySymbol> Properties { get; private set; }
    ...
    {
        public BoundCall(CSharpSyntaxNode syntax, BoundExpression receiverOpt, MethodSymbol method, ImmutableArray<BoundExpression> arguments, ImmutableArray<string> argumentNamesOpt, ImmutableArray<RefKind> argumentRefKindsOpt, bool isDelegateCall, bool expanded, bool invokedAsExtensionMethod, ImmutableArray<int> argsToParamsOpt, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
        ...
        public bool IsDelegateCall { get; private set; }

        public bool Expanded { get; private set; }

        public bool InvokedAsExtensionMethod { get; private set; }

        public ImmutableArray<int> ArgsToParamsOpt { get; private set; }
    ...
    {
        public BoundEventAssignmentOperator(CSharpSyntaxNode syntax, EventSymbol @event, bool isAddition, bool isDynamic, BoundExpression receiverOpt, BoundExpression argument, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundAttribute(CSharpSyntaxNode syntax, MethodSymbol constructor, ImmutableArray<BoundExpression> constructorArguments, ImmutableArray<string> constructorArgumentNamesOpt, ImmutableArray<BoundExpression> namedArguments, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<BoundExpression> ConstructorArguments { get; private set; }

        public ImmutableArray<string> ConstructorArgumentNamesOpt { get; private set; }

        public ImmutableArray<BoundExpression> NamedArguments { get; private set; }
    ...
    internal sealed partial class BoundObjectCreationExpression : BoundExpression
    {
        ...
        public ImmutableArray<MethodSymbol> ConstructorsGroup { get; private set; }
    ...
    {
        public BoundDynamicObjectCreationExpression(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> arguments, ImmutableArray<string> argumentNamesOpt, ImmutableArray<RefKind> argumentRefKindsOpt, BoundExpression initializerExpressionOpt, ImmutableArray<MethodSymbol> applicableMethods, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundNoPiaObjectCreationExpression(CSharpSyntaxNode syntax, string guidString, BoundExpression initializerExpressionOpt, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundObjectInitializerExpression(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> initializers, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundObjectInitializerMember(CSharpSyntaxNode syntax, Symbol memberSymbol, LookupResultKind resultKind, TypeSymbol type, bool hasErrors)
        ...
        public BoundObjectInitializerMember(CSharpSyntaxNode syntax, Symbol memberSymbol, LookupResultKind resultKind, TypeSymbol type)
    ...
    {
        public BoundCollectionInitializerExpression(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> initializers, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundCollectionElementInitializer(CSharpSyntaxNode syntax, MethodSymbol addMethod, ImmutableArray<BoundExpression> arguments, bool expanded, ImmutableArray<int> argsToParamsOpt, bool invokedAsExtensionMethod, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundDynamicCollectionElementInitializer(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> arguments, ImmutableArray<MethodSymbol> applicableMethods, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundAnonymousObjectCreationExpression(CSharpSyntaxNode syntax, MethodSymbol constructor, ImmutableArray<BoundExpression> arguments, ImmutableArray<BoundAnonymousPropertyDeclaration> declarations, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<BoundAnonymousPropertyDeclaration> Declarations { get; private set; }
    ...
    {
        public BoundNewT(CSharpSyntaxNode syntax, BoundExpression initializerExpressionOpt, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundDelegateCreationExpression(CSharpSyntaxNode syntax, BoundExpression argument, MethodSymbol methodOpt, bool isExtensionMethod, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundArrayCreation(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> bounds, BoundArrayInitialization initializerOpt, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<BoundExpression> Bounds { get; private set; }
    ...
    {
        public BoundArrayInitialization(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> initializers, bool hasErrors = false)
    ...
    {
        public BoundStackAllocArrayCreation(CSharpSyntaxNode syntax, BoundExpression count, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundFieldAccess(CSharpSyntaxNode syntax, BoundExpression receiverOpt, FieldSymbol fieldSymbol, ConstantValue constantValueOpt, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundPropertyAccess(CSharpSyntaxNode syntax, BoundExpression receiverOpt, PropertySymbol propertySymbol, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundEventAccess(CSharpSyntaxNode syntax, BoundExpression receiverOpt, EventSymbol eventSymbol, bool isUsableAsField, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundIndexerAccess(CSharpSyntaxNode syntax, BoundExpression receiverOpt, PropertySymbol indexer, ImmutableArray<BoundExpression> arguments, ImmutableArray<string> argumentNamesOpt, ImmutableArray<RefKind> argumentRefKindsOpt, bool expanded, ImmutableArray<int> argsToParamsOpt, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundDynamicIndexerAccess(CSharpSyntaxNode syntax, BoundExpression receiverOpt, ImmutableArray<BoundExpression> arguments, ImmutableArray<string> argumentNamesOpt, ImmutableArray<RefKind> argumentRefKindsOpt, ImmutableArray<PropertySymbol> applicableIndexers, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<PropertySymbol> ApplicableIndexers { get; private set; }
    ...
    internal sealed partial class BoundLambda : BoundExpression
    {
        ...
        public LambdaSymbol Symbol { get; private set; }
    ...
    {
        public BoundQueryClause(CSharpSyntaxNode syntax, BoundExpression value, RangeVariableSymbol definedSymbol, Binder binder, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundTypeOrInstanceInitializers(CSharpSyntaxNode syntax, ImmutableArray<BoundStatement> statements, bool hasErrors = false)
        ...
        internal R VisitInternal(BoundNode node, A arg)
        {
            switch (node.Kind)
            {
                ...
                case BoundKind.InitializationScope: 
                    return VisitInitializationScope(node as BoundInitializationScope, arg);
                case BoundKind.Dup: 
                ...
                case BoundKind.DeclarationExpression: 
                    return VisitDeclarationExpression(node as BoundDeclarationExpression, arg);
                case BoundKind.UninitializedVarDeclarationExpression: 
                    return VisitUninitializedVarDeclarationExpression(node as UninitializedVarDeclarationExpression, arg);
    ...
    internal abstract partial class BoundTreeVisitor<A,R>
    {
        ...
        public virtual R VisitInitializationScope(BoundInitializationScope node, A arg)
        {
            return this.DefaultVisit(node, arg);
        }
        ...
        public virtual R VisitDeclarationExpression(BoundDeclarationExpression node, A arg)
        {
            return this.DefaultVisit(node, arg);
        }
        public virtual R VisitUninitializedVarDeclarationExpression(UninitializedVarDeclarationExpression node, A arg)
        {
            return this.DefaultVisit(node, arg);
        }
    ...
    internal abstract partial class BoundTreeVisitor
    {
        ...
        public virtual BoundNode VisitInitializationScope(BoundInitializationScope node)
        {
            return this.DefaultVisit(node);
        }
        ...
        public virtual BoundNode VisitDeclarationExpression(BoundDeclarationExpression node)
        {
            return this.DefaultVisit(node);
        }
        public virtual BoundNode VisitUninitializedVarDeclarationExpression(UninitializedVarDeclarationExpression node)
        {
            return this.DefaultVisit(node);
        }
    ...
    internal abstract partial class BoundTreeWalker: BoundTreeVisitor
    {
        ...
        public override BoundNode VisitInitializationScope(BoundInitializationScope node)
        {
        ...
        public override BoundNode VisitUninitializedVarDeclarationExpression(UninitializedVarDeclarationExpression node)
        {
            this.VisitList(node.ArgumentsOpt);
            return null;
        }
    ...
    internal abstract partial class BoundTreeRewriter : BoundTreeVisitor
    {
        ...
        public override BoundNode VisitInitializationScope(BoundInitializationScope node)
        {
            ImmutableArray<BoundInitializer> initializers = (ImmutableArray<BoundInitializer>)this.VisitList(node.Initializers);
            return node.Update(node.Locals, initializers);
        }
        public override BoundNode VisitDup(BoundDup node)
        {
        ...
        public override BoundNode VisitConversion(BoundConversion node)
        {
            BoundExpression operand = (BoundExpression)this.Visit(node.Operand);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(operand, node.ConversionKind, node.ResultKind, node.IsBaseConversion, node.SymbolOpt, node.Checked, node.ExplicitCastInCode, node.IsExtensionMethod, node.IsArrayIndex, node.ConstantValueOpt, type);
        }
        public override BoundNode VisitArgList(BoundArgList node)
        {
            TypeSymbol type = this.VisitType(node.Type);
        ...
        public override BoundNode VisitSwitchSection(BoundSwitchSection node)
        {
            ImmutableArray<BoundSwitchLabel> boundSwitchLabels = (ImmutableArray<BoundSwitchLabel>)this.VisitList(node.BoundSwitchLabels);
            ImmutableArray<BoundStatement> statements = (ImmutableArray<BoundStatement>)this.VisitList(node.Statements);
        ...
        public override BoundNode VisitIfStatement(BoundIfStatement node)
        {
            ...
            return node.Update(node.Locals, condition, consequence, alternativeOpt);
        }
        public override BoundNode VisitDoStatement(BoundDoStatement node)
        {
            BoundExpression condition = (BoundExpression)this.Visit(node.Condition);
            BoundStatement body = (BoundStatement)this.Visit(node.Body);
            return node.Update(node.InnerLocals, condition, body, node.BreakLabel, node.ContinueLabel);
        }
        public override BoundNode VisitWhileStatement(BoundWhileStatement node)
        {
            BoundExpression condition = (BoundExpression)this.Visit(node.Condition);
        ...
        public override BoundNode VisitForEachStatement(BoundForEachStatement node)
        {
            ...
            BoundExpression expression = (BoundExpression)this.Visit(node.Expression);
            BoundStatement body = (BoundStatement)this.Visit(node.Body);
            return node.Update(node.OuterLocals, node.EnumeratorInfoOpt, node.ElementConversion, iterationVariableType, node.IterationVariable, expression, body, node.Checked, node.BreakLabel, node.ContinueLabel);
        }
        public override BoundNode VisitUsingStatement(BoundUsingStatement node)
        {
        ...
        public override BoundNode VisitCatchBlock(BoundCatchBlock node)
        {
            ...
            return node.Update(node.Locals, exceptionSourceOpt, exceptionTypeOpt, exceptionFilterOpt, body);
        }
        public override BoundNode VisitLiteral(BoundLiteral node)
        {
            TypeSymbol type = this.VisitType(node.Type);
        ...
        public override BoundNode VisitDeclarationExpression(BoundDeclarationExpression node)
        {
            ...
            ImmutableArray<BoundExpression> argumentsOpt = (ImmutableArray<BoundExpression>)this.VisitList(node.ArgumentsOpt);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(node.LocalSymbol, declaredType, initializerOpt, argumentsOpt, type);
        }
        public override BoundNode VisitUninitializedVarDeclarationExpression(UninitializedVarDeclarationExpression node)
        {
            ImmutableArray<BoundExpression> argumentsOpt = (ImmutableArray<BoundExpression>)this.VisitList(node.ArgumentsOpt);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(node.LocalSymbol, argumentsOpt);
        }
        public override BoundNode VisitRangeVariable(BoundRangeVariable node)
        {
            BoundExpression value = (BoundExpression)this.Visit(node.Value);
    ...
    internal sealed class BoundTreeDumperNodeProducer : BoundTreeVisitor<object, TreeDumperNode>
    {
        ...
        public override TreeDumperNode VisitInitializationScope(BoundInitializationScope node, object arg)
        {
            return new TreeDumperNode("initializationScope", null, new TreeDumperNode[]
            {
        ...
        public override TreeDumperNode VisitDeclarationExpression(BoundDeclarationExpression node, object arg)
        {
            return new TreeDumperNode("declarationExpression", null, new TreeDumperNode[]
            {
                new TreeDumperNode("localSymbol", node.LocalSymbol, null),
                new TreeDumperNode("declaredType", null, new TreeDumperNode[] { Visit(node.DeclaredType, null) }),
                new TreeDumperNode("initializerOpt", null, new TreeDumperNode[] { Visit(node.InitializerOpt, null) }),
        ...
        public override TreeDumperNode VisitUninitializedVarDeclarationExpression(UninitializedVarDeclarationExpression node, object arg)
        {
            return new TreeDumperNode("uninitializedVarDeclarationExpression", null, new TreeDumperNode[]
            {
                new TreeDumperNode("localSymbol", node.LocalSymbol, null),
                new TreeDumperNode("argumentsOpt", null, node.ArgumentsOpt.IsDefault ? new TreeDumperNode[0] : from x in node.ArgumentsOpt select Visit(x, null)),
                new TreeDumperNode("type", node.Type, null)
