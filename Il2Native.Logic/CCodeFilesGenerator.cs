...
if (MSVC)
    ...
    SET(CMAKE_CXX_FLAGS_DEBUG ""${CMAKE_CXX_FLAGS_DEBUG} -O0 -ggdb -fvar-tracking-assignments -gdwarf-4 -DDEBUG -march=native -std=gnu++14 -fpermissive -Winvalid-offsetof"")
    SET(CMAKE_CXX_FLAGS_RELEASE ""${CMAKE_CXX_FLAGS_RELEASE} -O2 -march=native -std=gnu++14 -fpermissive -Winvalid-offsetof"")
endif()
