...
if (MSVC)
    ...
    SET(CMAKE_CXX_FLAGS_DEBUG ""${CMAKE_CXX_FLAGS_DEBUG} /Od /Zi /EHsc /wd4250 /wd4200 /MP8"")
    SET(CMAKE_CXX_FLAGS_RELEASE ""${CMAKE_CXX_FLAGS_RELEASE} /Ox /EHsc /wd4250 /wd4200 /MP8"")
else()
    if (CMAKE_BUILD_TYPE STREQUAL ""Debug"")
