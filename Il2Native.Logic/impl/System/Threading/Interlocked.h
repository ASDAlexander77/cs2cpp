...
template <typename T> 
T CoreLib::System::Threading::Interlocked::Exchange_Ref<T>(T& location1, T value)
{
    throw 3221274624U;
}
...
template <typename T> 
T CoreLib::System::Threading::Interlocked::CompareExchange_Ref<T>(T& location1, T value, T comparand)
{
