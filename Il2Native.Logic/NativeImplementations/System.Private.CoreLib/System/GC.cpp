...
namespace CoreLib { namespace System { 
    ...
    // Method : System.GC._StartNoGCRegion(long, bool, long, bool)
    int32_t GC::_StartNoGCRegion(int64_t totalSize, bool lohSizeKnown, int64_t lohSize, bool disallowFullBlockingGC)
    {
        throw 3221274624U;
    }
    
    // Method : System.GC._EndNoGCRegion()
    int32_t GC::_EndNoGCRegion()
    {
        throw 3221274624U;
    }
    ...
    void GC::SetLOHCompactionMode(int32_t newLOHCompactionMode)
    {
        throw 3221274624U;
    }
    ...
    int64_t GC::_GetAllocatedBytesForCurrentThread()
    {
        throw 3221274624U;
    }
