...
namespace Il2Native.Logic
{
    ...
    public class CWriter : BaseWriter, ICodeWriter
    {
        ...
        static CWriter()
        {
            ...
            // exclude methods
            excludeMethods.Add(new Tuple<string, string>("System.Reflection.MethodBase", "get_Is*"));
            excludeMethods.Add(new Tuple<string, string>("System.Runtime.InteropServices._Exception", "Equals;GetHashCode"));

            excludeMethodsBody.Add(new Tuple<string, string>("System.Enum", "GetValue;GetHashCode"));
        }
        ...
        /// </param>
        public CWriter(string fileName, WritingMode writingMode = WritingMode.Standart, bool nestTypes = true)
        {
        ...
        public void WriteConstructorStart(ConstructorInfo ctor)
        {
            ...
            {
                if (ctor.IsPrivate && !ctor.IsStatic)
                {
            ...
            this.WriteMethodName(this.Output, ctor, this.writingMode == WritingMode.CodeOnly, false, this.writingMode == WritingMode.CodeOnly);
            if (ctor.IsStatic)
            {
            ...
            ////if (ctor.DeclaringType.IsGenericType)
            ////{
            ////    WriteTemplate(ctor.DeclaringType);
            ////}
        ...
        public void WriteForwardDeclaration(Type type, int number, int count)
        {
            ...
            if (type.IsPrimitiveType() || type.IsVoid() || (type.IsNested && this.nestTypes) || type.IsConstructedGenericType)
            {
                if (isLastType)
                {
            ...
            this.WriteNamespaceStart(this.Output, type, true, number == 0);
            ...
            {
                WriteArrayDeclaration();
            }

            if (isLastType)
            {
                WriteNamespaceEnd(this.Output, type);
                this.Output.WriteLine(string.Empty);
            }
        }
        ...
        public void WriteMethodStart(MethodInfo method)
        {
            ...
            if (method.DeclaringType.IsInterface && method.Name == "ToString" && method.GetParameters().Length == 0)
            {
                return;
            }
            ...
            if (methodBodyBytes == null && this.writingMode == WritingMode.CodeOnly)
            {
                return;
            }
            ...
            else
            {
                ...
                {
                    this.WriteTemplateDefintion(method.DeclaringType);
                }
            }
            ...
            if (this.writingMode != WritingMode.CodeOnly)
            {
                ...
                if (method.IsVirtual && !method.IsGenericMethod)
                {
                    this.Output.Write("virtual ");
                }
            }
            ...
            this.WriteMethodName(this.Output, method, this.writingMode == WritingMode.CodeOnly, false, this.writingMode == WritingMode.CodeOnly);
            if (method.IsGenericMethod)
            {
            ...
            if (methodBodyBytes != null)
            {
                ...
                if (method.Name == "GetValue" && method.DeclaringType.Name == "Enum")
                {
                    int i = 0;
                }
        ...
        public void WriteStart(string moduleName)
        {
            if (this.writingMode == WritingMode.CodeOnly)
            {
                ...
                this.Output.WriteLine(Resources.operations);
                this.Output.WriteLine(string.Empty);
...
#if USE_C_STRING
            this.Output.WriteLine("namespace System {");
            this.Output.WriteLine(string.Empty);
            this.Output.Indent++;
            ...
            this.Output.Indent--;
            this.Output.WriteLine("}");
            this.Output.WriteLine("public: template<typename T> static void WriteLine(string s, T t) {");
            this.Output.Indent++;
            this.Output.WriteLine("cout << s.c_str() << t << endl;");
            this.Output.Indent--;
            this.Output.WriteLine("}");
            ...
            this.Output.Indent++;
            this.Output.WriteLine("public: static bool op_Equality_b(string s1, string s2) {");
            this.Output.Indent++;
            this.Output.WriteLine("return s1.compare(s2) == 0;");
            this.Output.Indent--;
            this.Output.WriteLine("}");
            this.Output.WriteLine("public: static bool op_Inequality_b(string s1, string s2) {");
            this.Output.Indent++;
            this.Output.WriteLine("return s1.compare(s2) != 0;");
            this.Output.Indent--;
            this.Output.WriteLine("}");
            this.Output.WriteLine("public: static string Concat_str(string s1, string s2) {");
            this.Output.Indent++;
            ...
            this.Output.Indent--;
            this.Output.WriteLine("}");
            this.Output.WriteLine("public: static string Concat_str(string s1, int i) {");
            this.Output.Indent++;
            this.Output.WriteLine("string r;");
            this.Output.WriteLine("r.append(s1);");
            ...
            this.Output.Indent--;
            this.Output.WriteLine("}");
            this.Output.WriteLine("public: static string Concat_str(string s1, string s2, string s3) {");
            this.Output.Indent++;
            this.Output.WriteLine("string r;");
            this.Output.WriteLine("r.append(s1);");
            this.Output.WriteLine("r.append(s2);");
        ...
        public void WriteArrayDeclaration()
        {
            //this.Output.WriteLine("namespace System {");
            this.Output.WriteLine("template <typename T> class Array_T1;");
            //this.Output.WriteLine("}");
        }

        public void WriteArrayDefinition()
        {
            this.Output.WriteLine("namespace System {");
            this.Output.WriteLine("	template <typename T> class Array_T1: public System::Array");
            this.Output.WriteLine("	{");
            this.Output.WriteLine("		public: T operator[](int index) const;");
            this.Output.WriteLine("		public: T& operator[](int index);");
            this.Output.WriteLine("		public: static System::Array_T1<T>* New();");
            this.Output.WriteLine("	};");
            this.Output.WriteLine("}");
            this.Output.WriteLine(string.Empty);
        }

        public void WriteArrayBody()
        {
            this.Output.WriteLine("template <typename T> System::Array_T1<T>* System::Array_T1<T>::New() {");
            this.Output.WriteLine("	auto c = new System::Array_T1<T>();");
            this.Output.WriteLine("	c->_ctor();");
            this.Output.WriteLine("	return c;");
            this.Output.WriteLine("};");
            this.Output.WriteLine(string.Empty);
            this.Output.WriteLine("template <typename T> T System::Array_T1<T>::operator[](int index) const {");
            this.Output.WriteLine("	return (T) nullptr;");
            this.Output.WriteLine("};");
            this.Output.WriteLine("template <typename T> T& System::Array_T1<T>::operator[](int index) {");
            this.Output.WriteLine("	return nullptr;");
            this.Output.WriteLine("};");
            this.Output.WriteLine(string.Empty);
        }
        ...
        public void WriteTypeEnd(Type type)
        {
            if (this.writingMode != WritingMode.CodeOnly)
            {
                this.Output.Indent--;
                this.Output.WriteLine("};");
                if (!type.IsNested || !this.nestTypes)
                {
                    WriteNamespaceEnd(this.Output, type);
                }
            ...
            if (this.StaticConstructors.Any())
            {
                ...
                this.WriteTypeNoModifiers(this.Output, type);
                this.Output.WriteLine("::_cctor_Static();");
            }
        ...
        public void WriteTypeStart(Type type, Type genericDefinition)
        {
            ...
            if (!type.IsNested || !this.nestTypes)
            {
                this.WriteNamespaceStart(this.Output, type, false, false);
            }
            else
            {
                this.Output.Write("public: ");
            ...
            if (index == 0 && type.IsInterface)
            {
                ...
                this.Output.Write(": public virtual System::Object");
            }
        ...
        /// <returns>
        /// </returns>
        private static string TypeToCShortType(Type type)
        {
            ...
            {
                string ctype;
                if (systemTypesToCShortTypes.TryGetValue(effectiveType.Name, out ctype))
                {
                    return type.IsArray ? string.Concat(ctype, "ptr") : ctype;
                }
            }

            if (effectiveType.IsValueType && effectiveType.IsPrimitive)
            {
                var ret = effectiveType.Name.ToLowerInvariant();
                return type.IsArray ? string.Concat(ret, "ptr") : ret;
            }

            var ret2 = (effectiveType.Namespace != null ? string.Concat(effectiveType.Namespace, '_', effectiveType.Name) : effectiveType.Name).Replace(
                '.', '_');
            return type.IsArray ? string.Concat(ret2, "ptr") : ret2;
        }
        ...
        /// <returns>
        /// </returns>
        private static string TypeToCType(Type type, bool cleanName = false, bool doNotConvertName = false)
        {
            var effectiveType = type;
            ...
            if (!doNotConvertName && type.IsValueType && type.IsPrimitive)
            {
            ...
            if (!cleanName && !string.IsNullOrWhiteSpace(type.Namespace) && !effectiveType.IsGenericParameter)
            {
        ...
        /// <param name="anyone">
        /// </param>
        private static void WriteParameterSuffix(IndentedTextWriter writer, Type parameterType, ref bool any, ref bool anyone)
        {
            if (parameterType.HasElementType)
            {
                WriteParameterSuffix(writer, parameterType.GetElementType(), ref any, ref anyone);
            }
            ...
            if (parameterType.Namespace == "System" && parameterType.Name == "UIntPtr")
            {
                if (!any)
                {
                    writer.Write('_');
        ...
        private Ending ActualWriteOpCode(IndentedTextWriter writer, OpCodePart opCode, Ending endings)
        {
            ...
            switch (code)
            {
                ...
                case Code.Ldstr:
                    ...
                    writer.Write("System::String::New(\"");
                ...
                case Code.Newobj:
                    ...
                    // writer.Write("new ");
                    this.WriteTypeNoModifiers(writer, declaringType, false, true);
                    writer.Write("::New");
                    WriteParametersSuffix(writer, (opCode as OpCodeConstructorInfoPart).Operand.GetParameters());
                ...
                case Code.Newarr:
                    ...
                    writer.Write("System::Array_T1<");
                    WriteTypePrefix(writer, opCodeTypePart.Operand, false);
                    writer.Write(">::New()");
                ...
                case Code.Initobj:
                    ...
                    this.WriteTypeNoModifiers(writer, opCodeTypePart.Operand, false, true);
                    writer.Write("::New()");
        ...
        private void WriteCall(IndentedTextWriter writer, OpCodeMethodInfoPart opCodeMethodInfo, bool isVirtual, bool hasThis)
        {
            ...
            this.WriteMethodName(writer, methodBase, true /*methodBase.IsStatic*/, startsWithThis);
        ...
        private void WriteFactoryMethodNew(ConstructorInfo ctor)
        {
            ...
            this.WriteTypePrefix(this.Output, ctor.DeclaringType, false);
            ...
            if (this.writingMode == WritingMode.CodeOnly)
            {
                ...
                this.Output.Write("auto c = new ");
                this.WriteTypeNoModifiers(this.Output, ctor.DeclaringType, false, true);
                this.Output.WriteLine("();");
                this.Output.Write("c->");
                this.WriteMethodName(this.Output, ctor, false, false, this.writingMode == WritingMode.CodeOnly);
        ...
        /// </param>
        private void WriteFieldOrMethodName(IndentedTextWriter writer, string fieldOrMethodName, bool methodDeclaration = false, bool isGenericMethod = false)
        {
            if (methodDeclaration && (char.IsLetter(fieldOrMethodName[0]) || fieldOrMethodName[0] == '_'))
            {
                var parsed = new ParsedType(fieldOrMethodName);

                if (this.TypeGenericArguments != null && this.TypeGenericArguments.All(t => !t.IsGenericParameter))
                {
                    // resolve types
                    parsed.ResolveGenerics(this.TypeGenericArguments);
                }

                parsed.ResolveTypes(this.GetAllInterfaces(this.ThisType).ToArray());
                var ctype = parsed.ToCString(this, true, isGenericMethod ? -1 : -2);
                fieldOrMethodName = ctype;
            }
            else
            {
        ...
        /// <param name="isGenericMethod">
        /// </param>
        private void WriteMemberName(
            IndentedTextWriter writer,
            MemberInfo memberInfo,
            bool withNamespace = false,
            bool ifDifferent = true,
            bool useGenericArguments = false,
    ...
    // TODO: hack for now
                if (memberInfo.DeclaringType.FullName == "System.String")
                {
                    writer.Write("System::String");
                }
                else
                {
#endif
                this.WriteTypeNoModifiers(writer, memberInfo.DeclaringType, useGenericArguments, true);
#if USE_C_STRING
                }
#endif
            ...
            // TODO: hack here
            this.WriteFieldOrMethodName(writer, memberInfo.Name, true, isGenericMethod);
        }
        ...
        private void WriteMethodName(
            IndentedTextWriter writer, MethodBase methodBase, bool withNamespace = false, bool hasThis = false, bool useGenericArguments = false)
        {
            this.WriteMemberName(writer, methodBase, withNamespace, hasThis, useGenericArguments, methodBase.IsGenericMethod);
        ...
        private void WriteName(IndentedTextWriter writer, Type type, bool cleanName = false, bool methodPrefixName = false, bool doNotConvertName = false)
        {
            ...
            if (type.IsNested && this.nestTypes && !cleanName)
            {
                this.WriteTypeNoModifiers(writer, type.DeclaringType, false, true);
                writer.Write("_");
                cleanName = true;
            }
            else if (type.IsNested && !this.nestTypes && !methodPrefixName)
            {
                this.WriteName(writer, type.DeclaringType, cleanName, false, true);
                writer.Write("_");
                cleanName = true;
            }

            var typeBaseName = methodPrefixName ? TypeToCShortType(type) : TypeToCType(type, cleanName, doNotConvertName);
            WriteName(writer, typeBaseName, cleanName);
        }
        ...
        /// <param name="cleanName">
        /// </param>
        private void WriteName(IndentedTextWriter writer, string typeBaseName, bool cleanName = false)
        {
            // clean name
            ...
            if (index >= 0)
            {
                typeBaseName = typeBaseName.Replace("`", "_T");
            }
        ...
        private void WriteParametersSuffix(IndentedTextWriter writer, IEnumerable<ParameterInfo> parameters)
        {
            ...
            foreach (var parameter in parameters)
            {
                ...
                WriteParameterSuffix(writer, parameter.ParameterType, ref any, ref anyone);
        ...
        public class ParsedType
        {
            ...
            /// <returns>
            /// </returns>
            public static Type GetTypeFromTypeName(string typeName, CWriter writer)
            {
            ...
            /// <returns>
            /// </returns>
            public string AsCString(string typeName, CWriter writer)
            {
            ...
            /// <returns>
            /// </returns>
            public string AsCString(Type type, CWriter writer)
            {
                if (type != null)
                {
                    return writer.TypeToString(type);
            ...
            /// <returns>
            /// </returns>
            public string ToCString(CWriter writer, bool clean = true, int skip = 0)
            {
