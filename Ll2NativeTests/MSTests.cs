...
extern void GC_init();
extern Byte* GC_malloc(Int32);
extern Byte* GC_malloc_atomic(Int32);
extern Byte* GC_realloc(Byte*, Int32);
extern Int32 GC_get_heap_size();
...
const char* _RTTI_System_Object_String_Name = "13System.Object\00";
extern "C" struct { Byte* f1; Byte* f2; } _RTTI_System_Object_Info = {
    (Byte*)_ZTVN10__cxxabiv120__si_class_type_infoE[2],
    (Byte*)&_RTTI_System_Object_String_Name,
};

const char* _RTTI_System_Object_Pointer_String_Name = "P13System.Object\00";
static struct { Byte* f1; Byte* f2; Int32 f3; Byte* f4; } _RTTI_System_Object_Pointer_Info = {
    (Byte*)_ZTVN10__cxxabiv119__pointer_type_infoE[2],
    (Byte*)&_RTTI_System_Object_Pointer_String_Name,
    0,
...
extern "C" struct System_String {
    System_Object base;
    anyFn* System_IComparable;
    Int32 m_stringLength;
    Char m_firstChar;
};

extern "C" void Void_System_Object__ctorFN(System_Object* this_0)
{
}

extern "C" void Void_System_Console_WriteLineFSystem_StringN(System_String* value_0)
{
	wprintf((wchar_t*)&value_0->m_firstChar);
	printf("\r\n");
}

extern "C" void Void_System_Console_WriteLineFInt32N(Int32 value_0)
{
	printf("%i\r\n", value_0);
}

extern "C" System_String* System_String_System_Object_ToStringFN(System_Object* this_0)
{
	return 0;
}

extern "C" Boolean Boolean_System_Object_EqualsFSystem_ObjectN(System_Object* this_0, System_Object* obj_1)
{
	return 0;
}

extern "C" Int32 Int32_System_Object_GetHashCodeFN(System_Object* this_0)
{
	return 0;
}

extern "C" void Void_System_Object_FinalizeFN(System_Object* this_0)
{
}

extern "C" struct System_Int32;

extern "C" System_Int32* System_Int32_System_Int32__boxFInt32N(Int32 value_0)
{
	return 0;
}
         * */
